package com.maoxian.scheduler.docker;
...
public class UnCompress {
    ...
    public static String getImageNameAndId(String tempFilePath) throws Exception {
        System.out.println("tempFilePath = " + tempFilePath);
        // String dirPath = tempFilePath.substring(0, tempFilePath.lastIndexOf("."));
        String dirPath = tempFilePath + "_folder";
        ...
        deleteDir(dirFile);
        String imageName = ((List<String>) jsonList.get(0).get("RepoTags")).get(0);
        String imageId = (String) jsonList.get(0).get("Config");
    ...
    public static void main(String[] args) throws Exception {
        String str = getImageNameAndId("E:\\nginx.latest.tar");
